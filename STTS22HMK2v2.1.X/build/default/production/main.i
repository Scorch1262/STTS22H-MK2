...
# 84 "main.c"
    ...
    I2C_Write1ByteRegister(0x3F,0x0c,0x30);

    _delay((unsigned long)((500)*(8000000/4000.0)));

    while (1){
        I2C_Write1ByteRegister(0x3F,0x0c,0x02);
        I2C_Write1ByteRegister(0x3F,0x0c,0x00);
        Data = I2C_Read2ByteRegister(0x3F,0x04);
        Data = Data + 1;
        I2C_Write1ByteRegister(0x3F,0x04,Data);

        temperature_low = I2C_Read1ByteRegister(0x3F,0x06);
        temperature = I2C_Read1ByteRegister(0x3F,0x07);
        ...
        temperatureAnz = temperature / 100.00;
